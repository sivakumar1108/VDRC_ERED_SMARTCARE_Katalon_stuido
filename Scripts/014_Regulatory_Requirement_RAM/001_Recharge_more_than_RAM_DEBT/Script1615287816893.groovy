...
WS.sendRequest(findTestObject('REGULATORY_REQUIREMENT/02_RAM_Bundle purchase'), FailureHandling.STOP_ON_FAILURE)
...
GlobalVariable.RAM_Recharge = '180000'

WS.sendRequest(findTestObject('REGULATORY_REQUIREMENT/03_RAM_Recharge'), FailureHandling.STOP_ON_FAILURE)
...
WS.comment('Recharge More than RAM_DEBT flow is working fine.')
