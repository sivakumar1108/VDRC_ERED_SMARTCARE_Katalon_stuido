...
Response = WS.sendRequest(findTestObject('004_J4U_Apioffers_automation/01_Target_Normal/04_j4u-Target Hourly'), FailureHandling.CONTINUE_ON_FAILURE)
...
WS.comment('Normal ML Hourly offers flow is working fine for Targeted customer.')
