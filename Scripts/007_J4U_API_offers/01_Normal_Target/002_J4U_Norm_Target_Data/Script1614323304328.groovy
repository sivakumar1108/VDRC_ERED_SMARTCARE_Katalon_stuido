...
Response = WS.sendRequest(findTestObject('004_J4U_Apioffers_automation/01_Target_Normal/02_j4u-Target Data'), FailureHandling.CONTINUE_ON_FAILURE)
...
WS.comment('Normal ML Data offers flow is working fine for Targeted customer.')
