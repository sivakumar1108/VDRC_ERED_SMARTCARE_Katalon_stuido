...
Response = WS.sendRequest(findTestObject('004_J4U_Apioffers_automation/01_Target_Normal/01_j4u-Target Voice'), FailureHandling.CONTINUE_ON_FAILURE)
...
WS.comment('Normal ML Voice offers flow is working fine for Targeted customer.')
